...
% Last Modified by GUIDE v2.5 12-Apr-2023 14:31:55
...
function edit2callback_Callback(hObject, eventdata, handles)
% hObject    handle to edit2callback (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit2callback as text
%        str2double(get(hObject,'String')) returns contents of edit2callback as a double


% --- Executes during object creation, after setting all properties.
function edit2callback_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit2callback (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
